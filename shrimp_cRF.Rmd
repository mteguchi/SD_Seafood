...
The vairance explained is pseudo.R2 = 0.77 as of Feb 25, 2019, using "PRICE ~ SP_GROUP_f+SIZE_GROUP_f + SHRIMP_PROCESSING_f + YEAR + ZIP_f + MARKETTYPE_f + ECOLABEL_f + PROD_METHOD_f + RV". 
...
fit.farm$df %>% group_by(ZIP_f) %>%
  summarise(mean_by_ZIP = mean(PREDICT))-> mean.PRICE.farm.by.ZIP
