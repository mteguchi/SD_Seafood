...
if (!file.exists("RData/RF_M_1_importance.rds")){
  ...
  saveRDS(importance_df, file = "RData/RF_1_importance.rds")
} else {
...
```{r}
plot_multi_way_importance(importance_df, x_measure = "mse_increase", y_measure = "node_purity_increase", size_measure = "p_value", no_of_labels = 5)
```
